...
Config.Zonas = {
    ...
    ["atms"] = {
        ...
        {name="ATM", id=277, x=129.216, y=-1292.347, z=29.269}, --PUTICLUB
        ...
        {name="ATM", id=277, x = 435.5, y = -976.65, z = 30.72}, --PD
        {name="ATM", id=277, x = -190.2, y = -1309.55, z = 31.3}, --Mecánico
        {name="ATM", id=277, x = -446.629, y = -328.399, z = 34.502}, -- Hospital
        {name="ATM", id=277, x = 230.89, y = 367.46, z = 106.11}, -- AUTOESCUELA
        {name="ATM", id=277, x = -42.75, y = -1108.63, z = 25.44}, -- Concesionario
        {name="ATM", id=277, x = 311.06, y = -910.94, z = 29.29}, -- GC
        {name="ATM", id=277, x = -567.46, y = 274.05, z = 83.02}, -- tequila
        {name="ATM", id=277, x = -644.45, y = -281.63, z = 34.55}, -- electronica
        {name="ATM", id=277, x = -866.47, y = -186.52, z = 37.71}, -- concevip
        {name="ATM", id=277, x = 934.459, y = 31.448, z = 80.292}, -- casino 1
        {name="ATM", id=277, x = 942.627, y = 44.541, z = 80.292}, -- casino 2
        {name="ATM", id=277, x = -660.802, y = -854.063, z = 24.485}, -- casino 2
        {name="ATM", id=277, x = 903.513, y = -163.946, z = 74.169}, -- tasistas
    }   
}